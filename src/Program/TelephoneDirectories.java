...
public class TelephoneDirectories {
        ...
        protected String caller1;
        protected String caller1location;
        protected String caller2;
        ...
        public String getCaller1Location() {
            return caller1location;
        }

        public void setCaller1Location(String caller1location) {
            this.caller1location = caller1location;
        }
        ...
        public String getCaller2Location() {
            return caller2location;
        }

        public void setCaller2Location(String caller2location) {
            this.caller2location = caller2location;
        }
        ...
        public String getCaller3Location() {
            return caller3location;
        }
